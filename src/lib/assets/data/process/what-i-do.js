        ...
        content: [
            {
                type: 'text',
                text: [
                    "<span class='highlight'>None of my projects happen in a vacuum</span>, whether it's a side project or client work. It's a small collection of folks supporting, inspiring and learning from one another that shape the work I put out.",
                    "I can't count the number of times a conversation with one of them has lead to me starting a side project, creating art or brainstorming a conference talk idea which would have never got off the ground otherwise.",
                    "Hell, even this site would have been a one pager resume if people didn't convince me to own my corner of the internet."
                ]
            }
        ]
    }

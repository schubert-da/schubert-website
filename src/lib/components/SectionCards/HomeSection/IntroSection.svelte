	...
	<div class="card">
		<div class="text-content">
			...
			<div class="description">
				<p>
					For the most part, I create interactives and <span class="highlight"
						>dataviz on the web</span
					>
				</p>
				<p>
					While I struggle to finish out a <span class="highlight">sketchbook</span> on the side
				</p>
			</div>
		</div>
